...
var FeatureStyleExtension = /** @class */ (function (_super) {
    ...
    FeatureStyleExtension.prototype.getFeatureStyleForFeatureRow = function (featureRow) {
        return new featureStyle_1.FeatureStyle(this.getStyle(featureRow.featureTable.table_name, featureRow.id, featureRow.geometryType, true), this.getIcon(featureRow.featureTable.table_name, featureRow.id, featureRow.geometryType, true));
    };
    /**
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.setTableStyles(featureTable, featureStyles.styles)];
                    case 1:
                        tableStyles = _a.sent();
                        return [4 /*yield*/, this.setTableIcons(featureTable, featureStyles.icons)];
                    case 2:
                        tableIcons = _a.sent();
                        return [2 /*return*/, {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(featureStyles !== null)) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.setStyles(featureTable, featureId, featureStyles.styles)];
                    case 1:
                        styles = _a.sent();
                        return [4 /*yield*/, this.setIcons(featureTable, featureId, featureStyles.icons)];
                    case 2:
                        icons = _a.sent();
                        return [2 /*return*/, {
                                styles: styles,
    ...
    FeatureStyleExtension.prototype.setFeatureStyleForFeatureRow = function (featureRow, featureStyle) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.setFeatureStyleForFeatureRowAndGeometryType(featureRow, featureRow.geometryType, featureStyle)];
            });
        });
    };
    /**
    ...
    FeatureStyleExtension.prototype.setStyleForFeatureRow = function (featureRow, style) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.setStyleForFeatureRowAndGeometryType(featureRow, featureRow.geometryType, style)];
            });
        });
    };
    /**
    ...
    FeatureStyleExtension.prototype.setIconForFeatureRow = function (featureRow, icon) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.setIconForFeatureRowAndGeometryType(featureRow, featureRow.geometryType, icon)];
            });
        });
    };
    /**
