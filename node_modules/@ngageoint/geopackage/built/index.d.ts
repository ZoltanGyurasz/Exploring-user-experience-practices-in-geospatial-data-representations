...
export { proj4Defs, GeoPackageAPI, GeoPackage, GeoPackageTileRetriever, GeoPackageConnection, TableCreator, MediaTable, UserMappingTable, DublinCoreType, TileColumn, TileUtilities, FeatureColumn, UserColumn, GeometryColumns, GeometryData, DataColumns, Metadata, MetadataReference, RTreeIndex, CrsWktExtension, SchemaExtension, MetadataExtension, WebPExtension, DataColumnsDao, DataColumnConstraintsDao, FeatureTableStyles, FeatureTiles, NumberFeaturesTile, ShadedFeaturesTile, BoundingBox, DataTypes, ClosestFeature, TileScaling, TileScalingType, ContentsDao, TileMatrixSet, TileMatrix, TileBoundingBoxUtils, };
