...
const GeoRasterLayer = L.GridLayer.extend({
    ...
    drawTile: function ({ tile, coords, context, done }) {
        try {
            ...
            if (debugLevel >= 3)
                log({ xScaleSignInMapCRS, yScaleSignInMapCRS });
            ...
            if (debugLevel >= 3)
                log({ xScaleOfScreenPixelInMapCRS, yScaleOfScreenPixelInMapCRS });
            const snapped = snap({
            ...
            if (debugLevel >= 3)
                console.log("setting tile height to " + innerTileHeight + "px");
            ...
            if (debugLevel >= 4)
                log({ rasterPixelsAcross, rasterPixelsDown });
            ...
            if (debugLevel >= 4)
                log({ percentHeight, percentWidth });
            ...
            if (debugLevel >= 4)
                console.log({ maxNumberOfSamplesAcross, maxNumberOfSamplesDown });
            ...
            if (debugLevel >= 4)
                console.log({ resolution, rasterPixelsAcross, numberOfSamplesAcross });
